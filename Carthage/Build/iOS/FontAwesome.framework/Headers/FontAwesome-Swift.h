...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FontAwesome",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC11FontAwesome24FontAwesomeBarButtonItem")
@interface FontAwesomeBarButtonItem : UIBarButtonItem
@property (nonatomic) BOOL isFontAwesomeCSSCode;
@property (nonatomic, copy) NSString * _Nonnull styleName;
...
SWIFT_CLASS("_TtC11FontAwesome21FontAwesomeTabBarItem")
@interface FontAwesomeTabBarItem : UITabBarItem
@property (nonatomic, copy) NSString * _Nonnull iconName;
@property (nonatomic, copy) NSString * _Nonnull selectedIconName;
@property (nonatomic) CGFloat size;
@property (nonatomic, copy) NSString * _Nonnull styleName;
- (void)awakeFromNib;
- (void)prepareForInterfaceBuilder;
