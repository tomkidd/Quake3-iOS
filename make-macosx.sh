...
#fi
(ARCH=${BUILDARCH} CFLAGS=$ARCH_CFLAGS MACOSX_VERSION_MIN=$ARCH_MACOSX_VERSION_MIN MOUNT_DIR=Quake3 BUILD_STANDALONE=0 BUILD_CLIENT=0 BUILD_SERVER=0 BUILD_GAME_SO=0 BUILD_RENDERER_OPENGL2=0 make -j$NCPU) || exit 1;
